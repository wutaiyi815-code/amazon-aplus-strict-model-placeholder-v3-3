...
def main() -> int:
    ...
    raise SystemExit(
        "Deprecated in v3.3: use tag_contact_sheet_with_toapi.py so every allowed SKU image is visually analyzed in one request; filename heuristics are forbidden."
    )
